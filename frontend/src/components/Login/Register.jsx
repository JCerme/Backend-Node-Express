    ...
    return (
        <div id="login" className="h-screen flex justify-center items-center">
            <div className="w-full flex-1">
                <form id="register_form" method="post" action="/api/register" className="w-2/3 mx-auto"
                onSubmit={(e) => sendRegister(e)}>
                    ...
                    <div className="grid grid-cols-2 w-full gap-4 mb-4">
                        <div className="flex flex-col w-full">
                            ...
                            <input type="text" name="first_name" id="first_name" className="bg-blue-100 focus:outline-blue-600 py-2 px-4 rounded border-b-2 border-blue-600 border-solid"/>
                        </div>
                        <div className="flex flex-col w-full">
                            <label htmlFor="last_name" className="mb-1">Last Name: *</label>
                            <input type="text" name="last_name" id="last_name" className="bg-blue-100 focus:outline-blue-600 py-2 px-4 rounded border-b-2 border-blue-600 border-solid"/>
                        </div>
                    </div>
                    ...
                    <span className="mt-4 text-gray-600 mt-4 block">
                        Do you have an account? <Link to="/login" className="text-blue-600 font-bold">Login here</Link>
                    </span>
                    ...
                    <a href="/auth/github" className="flex w-full gap-4 justify-center items-center py-2 px-4 rounded border border-black hover:shadow-xl duration-300">
                    ...
                    <a href="/auth/google" className="flex mt-4 w-full gap-4 justify-center items-center py-2 px-4 rounded border border-black hover:shadow-xl duration-300">
            ...
            <div className="p-4 flex-1 h-screen">
                <img src="/media/register.jpg" className="rounded-lg object-cover w-full h-full"/>
            </div>
        </div>
    )
}
